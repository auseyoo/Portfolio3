		...
		<form id="frm" name="frm" method="POST" >
			...
			<div class="inquiryBox">
				<dl>
					<dt>사번</dt>
					<dd>
						<input type="text" class="inp w160" name="admCd" id="admCd" value="" >
					</dd>
					<dt>사원명</dt>
					<dd>
						<input type="text" class="inp w160" name="admNm" id="admNm" value="" onkeydown="javascirpt:fn_onEnterSubmit();">
					</dd>
					<dd>
