...
public class CodeSupport3 extends EscapeBodyTag {
	...
	public int doStartTagInternal() {
		...
		try {
			...
			for(CommCodeVO m : result) {
				el += "<input type='radio' name='" + name +"' id='"+name+i+"' class='"+classNm+"' value='"+ m.getCommCd()+ "'>";
				el += "<label for='"+name+i+"'><span>"+m.getCommNm()+"</span></label>";
				i++;
			}
